...
* [Cava](https://github.com/karlstav/cava#latency-notes) ⭐ 6,432 | 🐛 18 | 🌐 C | 📅 2026-09-21 - A cross-platform terminal visualizer.
...
* [osci-render](https://github.com/jameshball/osci-render) ⭐ 733 | 🐛 20 | 🌐 C++ | 📅 2026-09-21 - Software for making music by visualising objects, images, and Blender scenes on an oscilloscope using audio.
...
* [meyda](https://github.com/meyda/meyda) ⭐ 1,668 | 🐛 70 | 🌐 TypeScript | 📅 2024-07-15 - Audio feature extraction for JavaScript.
...
* [web-audio-analyser](https://github.com/hughsk/web-audio-analyser) ⭐ 218 | 🐛 5 | 🌐 JavaScript | 📅 2020-07-30 - A thin wrapper around the Web Audio API that takes an <audio> element and gives you its waveform/frequency data in return.
* [Octavian](https://github.com/stevekinney/octavian) ⭐ 182 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-16 - Utilities for reasoning about musical notes, frequencies, and intervals
...
* [Pixi.js](https://github.com/pixijs/pixi.js/) ⭐ 48,213 | 🐛 351 | 🌐 TypeScript | 📅 2026-09-23 - A fast lightweight 2D library that works across all devices. The Pixi renderer allows everyone to enjoy the power of hardware acceleration without prior knowledge of WebGL.
* [Cava](https://github.com/karlstav/cava#latency-notes) ⭐ 6,432 | 🐛 18 | 🌐 C | 📅 2026-09-21 - A cross-platform terminal visualizer.
...
* [Clubber.js](https://github.com/wizgrav/clubber) ⭐ 377 | 🐛 5 | 🌐 JavaScript | 📅 2018-06-26 - Application of music theory in audio reactive visualizations.
...
Your contributions are always welcome! [Click here to read the guidelines](https://github.com/willianjusten/awesome-audio-visualization/blob/master/Contributing.md) ⭐ 5,079 | 🐛 16 | 🌐 Shell | 📅 2026-08-13.
