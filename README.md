...
* [Cava](https://github.com/karlstav/cava#latency-notes) ⭐ 6,380 | 🐛 18 | 🌐 C | 📅 2026-08-18 - A cross-platform terminal visualizer.
...
* [osci-render](https://github.com/jameshball/osci-render) ⭐ 725 | 🐛 22 | 🌐 C++ | 📅 2026-08-30 - Software for making music by visualising objects, images, and Blender scenes on an oscilloscope using audio.
...
* [audiowaveform](https://github.com/bbc/audiowaveform) ⭐ 2,157 | 🐛 43 | 🌐 C++ | 📅 2025-08-24 - C++ program to generate waveform data and render waveform images from audio files.
* [meyda](https://github.com/meyda/meyda) ⭐ 1,663 | 🐛 70 | 🌐 TypeScript | 📅 2024-07-15 - Audio feature extraction for JavaScript.
...
* [Pixi.js](https://github.com/pixijs/pixi.js/) ⭐ 48,097 | 🐛 344 | 🌐 TypeScript | 📅 2026-08-26 - A fast lightweight 2D library that works across all devices. The Pixi renderer allows everyone to enjoy the power of hardware acceleration without prior knowledge of WebGL.
* [Cava](https://github.com/karlstav/cava#latency-notes) ⭐ 6,380 | 🐛 18 | 🌐 C | 📅 2026-08-18 - A cross-platform terminal visualizer.
...
Your contributions are always welcome! [Click here to read the guidelines](https://github.com/willianjusten/awesome-audio-visualization/blob/master/Contributing.md) ⭐ 5,067 | 🐛 13 | 🌐 Shell | 📅 2026-08-13.
