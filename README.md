# Awesome audio visualization with stars
...
* [Cava](https://github.com/karlstav/cava#latency-notes) ⭐ 6,385 | 🐛 18 | 🌐 C | 📅 2026-08-18 - A cross-platform terminal visualizer.

## Experiments

* [p5.js Audio Visualizer](https://amandayehh.github.io/audio-visualizer/) - A powerful, beat- and amplitude-responsive audio visualizer created with [p5.sound](https://github.com/processing/p5.js-sound) ⭐ 910 | 🐛 194 | 🌐 JavaScript | 📅 2025-09-05, on an HTML5 Canvas by Amanda Yeh.

* [osci-render](https://github.com/jameshball/osci-render) ⭐ 725 | 🐛 21 | 🌐 C++ | 📅 2026-08-31 - Software for making music by visualising objects, images, and Blender scenes on an oscilloscope using audio.
...
* [Master Pro Audio Analyzer Suite](https://github.com/varunmaurya-git/Master-Pro-Audio-Analyzer) ⭐ 0 | 🐛 0 | 🌐 HTML | 📅 2026-08-22 - 100% private, client-side Web Audio analyzer with 8192-FFT Spectrogram, RTA, and Phase Scope.
...
* * [Multitrack Audio Visualizer](https://github.com/geoffmyers/multitrack-audio-visualizer) ⭐ 5 | 🐛 1 | 🌐 TypeScript | 📅 2026-03-21 - A real-time audio/music visualizer that displays multi-track waveforms with customizable colors and can export high-quality MP4/H.265 videos.
...
* [audiowaveform](https://github.com/bbc/audiowaveform) ⭐ 2,158 | 🐛 43 | 🌐 C++ | 📅 2025-08-24 - C++ program to generate waveform data and render waveform images from audio files.
* [meyda](https://github.com/meyda/meyda) ⭐ 1,664 | 🐛 70 | 🌐 TypeScript | 📅 2024-07-15 - Audio feature extraction for JavaScript.
...
* [p5.sound](https://github.com/processing/p5.js-sound) ⭐ 910 | 🐛 194 | 🌐 JavaScript | 📅 2025-09-05 - Brings the Processing approach to Web Audio and p5.js.
* [standardized-audio-context](https://github.com/chrisguttandin/standardized-audio-context) ⭐ 777 | 🐛 15 | 🌐 JavaScript | 📅 2026-08-30 - A cross-browser implementation of the AudioContext which aims to closely follow the standard.
...
* [web-audio-analyser](https://github.com/hughsk/web-audio-analyser) ⭐ 217 | 🐛 5 | 🌐 JavaScript | 📅 2020-07-30 - A thin wrapper around the Web Audio API that takes an <audio> element and gives you its waveform/frequency data in return.
...
* [audio-render](https://github.com/audio-lab/render) ⭐ 44 | 🐛 1 | 🌐 JavaScript | 📅 2015-11-10 - A pass-through audio stream, providing structure for rendering stream audio data.
* [web-media-playback](https://github.com/hughsk/web-media-playback) ⭐ 8 | 🐛 0 | 🌐 JavaScript | 📅 2015-11-28 - Retrieve playback and buffering information about audio or video playing in the browser.
...
* [Pixi.js](https://github.com/pixijs/pixi.js/) ⭐ 48,098 | 🐛 344 | 🌐 TypeScript | 📅 2026-08-26 - A fast lightweight 2D library that works across all devices. The Pixi renderer allows everyone to enjoy the power of hardware acceleration without prior knowledge of WebGL.
* [Cava](https://github.com/karlstav/cava#latency-notes) ⭐ 6,385 | 🐛 18 | 🌐 C | 📅 2026-08-18 - A cross-platform terminal visualizer.
...
* [Web Audio Extension](https://github.com/spite/WebAudioExtension) ⭐ 194 | 🐛 7 | 🌐 JavaScript | 📅 2017-01-04 - A Chrome extension to play with Web Audio.
* [wavebell](https://github.com/skylerlee/wavebell) ⭐ 51 | 🐛 4 | 🌐 JavaScript | 📅 2021-03-14 - A javascript voice recorder with realtime waveform, using web microphone
...
Your contributions are always welcome! [Click here to read the guidelines](https://github.com/willianjusten/awesome-audio-visualization/blob/master/Contributing.md) ⭐ 5,069 | 🐛 13 | 🌐 Shell | 📅 2026-08-13.
