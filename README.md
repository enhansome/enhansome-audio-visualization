...
* [Cava](https://github.com/karlstav/cava#latency-notes) ⭐ 6,424 | 🐛 18 | 🌐 C | 📅 2026-08-18 - A cross-platform terminal visualizer.
...
* [osci-render](https://github.com/jameshball/osci-render) ⭐ 731 | 🐛 21 | 🌐 C++ | 📅 2026-09-19 - Software for making music by visualising objects, images, and Blender scenes on an oscilloscope using audio.
...
* * [Multitrack Audio Visualizer](https://github.com/geoffmyers/multitrack-audio-visualizer) ⭐ 5 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-17 - A real-time audio/music visualizer that displays multi-track waveforms with customizable colors and can export high-quality MP4/H.265 videos.
...
* [audiowaveform](https://github.com/bbc/audiowaveform) ⭐ 2,164 | 🐛 43 | 🌐 C++ | 📅 2025-08-24 - C++ program to generate waveform data and render waveform images from audio files.
* [meyda](https://github.com/meyda/meyda) ⭐ 1,667 | 🐛 70 | 🌐 TypeScript | 📅 2024-07-15 - Audio feature extraction for JavaScript.
...
* [Pixi.js](https://github.com/pixijs/pixi.js/) ⭐ 48,189 | 🐛 338 | 🌐 TypeScript | 📅 2026-09-17 - A fast lightweight 2D library that works across all devices. The Pixi renderer allows everyone to enjoy the power of hardware acceleration without prior knowledge of WebGL.
* [Cava](https://github.com/karlstav/cava#latency-notes) ⭐ 6,424 | 🐛 18 | 🌐 C | 📅 2026-08-18 - A cross-platform terminal visualizer.
...
* [Circular Audio Wave](https://github.com/kelvinau/circular-audio-wave) ⭐ 282 | 🐛 14 | 🌐 JavaScript | 📅 2024-05-18 - A JS library for audio visualization in circular wave using Web Audio API and ECharts
* [Web Audio Extension](https://github.com/spite/WebAudioExtension) ⭐ 193 | 🐛 7 | 🌐 JavaScript | 📅 2017-01-04 - A Chrome extension to play with Web Audio.
...
Your contributions are always welcome! [Click here to read the guidelines](https://github.com/willianjusten/awesome-audio-visualization/blob/master/Contributing.md) ⭐ 5,072 | 🐛 16 | 🌐 Shell | 📅 2026-08-13.
